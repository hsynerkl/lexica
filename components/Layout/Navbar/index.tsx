    ...
    <nav className="h-14 flex justify-start md:justify-between bg-black-50 items-center bg-opacity-80 md:px-4 z-50 fixed bottom-0 md:top-0 w-screen backdrop-blur border-b border-b-zinc-700 border-opacity-80">
      <Link href="" rel="home" className="cursor-pointer">
        <svg
          ...
          className="h-5 md:h-5 md:flex hidden"
        >
          <path
      ...
      <ul className="[&>li]:text-white [&>li]:pt-1 md:flex hidden ">
        ...
        >
          <Link
            href="/"
            className={`py-2 px-4  group-hover:bg-black-100 rounded-md group-hover:!text-white ${
              router.pathname === "/"
                ? "text-white"
                : router.pathname === "/"
                ? "text-white"
        ...
        >
          <Link
            href="/generate"
            className={`group-hover:text-white py-2 px-4  group-hover:bg-black-100 rounded-md ${
      ...
      <ul className="w-full h-full gap-1 md:hidden flex justify-center">
        ...
        >
          <Link href="/generate">
            <svg
              stroke={`${
                router.pathname === "/generate" ? "white" : "#A1A1AA"
              }`}
              fill="none"
              strokeWidth={2}
              viewBox="0 0 24 24"
        ...
        >
          <Link href="/history">
            <svg
              stroke={`${router.pathname === "/history" ? "white" : "#A1A1AA"}`}
              fill="none"
              viewBox="0 0 16 16"
              className="w-full h-6"
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <Link href="/likes">
            <svg
              stroke={`${router.pathname === "/likes" ? "white" : "#A1A1AA"}`}
              fill="none"
              strokeWidth="2"
              viewBox="0 0 24 24"
              className="w-full h-6"
