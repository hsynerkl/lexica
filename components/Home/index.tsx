      ...
      >
        {filteredImages.length >= 1
          ? filteredImages?.map((item, index) => (
              <div
                className="aspect-h-1 aspect-w-1 group relative"
                key={item?.id}
              >
                <Image
                  src={item?.src}
                  ...
                  loading="eager"
                />
                <div className="inset-0 z-50 gap-2 p-2 absolute transition-all duration-150 cursor-pointer invisible text-white flex flex-col group-hover:visible bg-black-50">
                  <div className="flex justify-between">
                    <div className="p-2 h-fit hover:bg-black-100 hover:bg-opacity-30 hover:backdrop-blur transition-all duration-150 rounded-lg ">
                      <svg
                        stroke="white"
                        fill="none"
                        strokeWidth="2"
                  ...
                  <div className="flex items-end h-full">sa</div>
                </div>
              </div>
            ))
          : imgs?.map((item, index) => (
